    ...
    <div id="about" className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            I'm Veena Krishna, a Full Stack Engineer based near Seattle, WA.</p>
          <p> I
          ...
          <p>
            ...
            I am a computer science engineer with hands on experience in full
            stack web development in technologies such as NodeJS, Angular,
            React, Express and MongoDB. I have 5+ years of work experience in
            various roles with strong organizational skills, effective
